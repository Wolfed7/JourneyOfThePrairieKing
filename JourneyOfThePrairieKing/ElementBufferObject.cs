...
namespace JourneyOfThePrairieKing
{
   public sealed class ElementBufferObject : IDisposable
   {
      ...
      public ElementBufferObject(int indexCount, bool isStatic = true)
      {
         if (indexCount < ElementBufferObject.MinIndexCount ||
             indexCount > ElementBufferObject.MaxIndexCount)
         {
